...
//             multisig: Address.parse('0:3c5a3b70f47e4d843ff21c573c89ff9deac4d8b001d8c4d8f20782837c928fb5'),  // Replace with a valid Address
//             threshold: 2,
//             signers: [Address.parse('0:1c5a3b70f47e4d843ff21c573c89ff9deac4d8b001d8c4d8f20782837c928fb5'), Address.parse('0:2c5a3b70f47e4d843ff21c573c89ff9deac4d8b001d8c4d8f20782837c928fb5')], // Replace with valid Addresses
//             expiration_date: Date.now() + 1000 * 60 * 60, // Example expiration date (1 hour from now)
//             init_sender: Address.parse('0:1c5a3b70f47e4d843ff21c573c89ff9deac4d8b001d8c4d8f20782837c928fb5'), // Replace with a valid Address
//             approvals_mask: 0, // Example mask
//             approvals_num: 0, // Initial approvals count
//             salt: 42, // Example salt
//             opaque_order: new Cell(), // Create an instance of Cell as needed
//         };
        
//         orderContract = blockchain.openContract(Order.createFromConfig(config, code));
